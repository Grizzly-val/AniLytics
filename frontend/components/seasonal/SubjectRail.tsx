        ...
        <div className="relative flex items-center gap-2 mb-3 lg:mb-5">
          ...
          <div className="relative group/info">
            <button
              ...
              aria-label="About Seasonal Analytics subjects"
            ...
            >
              Explore real-time seasonal data from AniList, organized into categorical subjects — genre aggregates, popularity metrics, and anime breakdowns.
            </div>
          </div>
        </div>
