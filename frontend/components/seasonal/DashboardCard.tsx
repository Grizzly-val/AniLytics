...
export function DashboardCard({ dashboard }: DashboardCardProps) {
  return (
    <div className="group flex flex-col justify-between rounded-2xl border border-neutral-800 bg-neutral-900/60 p-6 sm:p-8 backdrop-blur-sm transition-all duration-200 hover:border-indigo-500/50 hover:bg-neutral-900/90 shadow-xl">
