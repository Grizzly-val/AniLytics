    ...
    >
      ...
      <div className="px-[20px] pt-4 pb-[18px] flex flex-col justify-between flex-1 relative z-20">
        <div>
          ...
          {/* Subtitle */}
          <p className="text-[11.5px] text-[var(--text-low)] leading-[1.4] mb-2 line-clamp-1">
            {secondaryTitle || "\u00A0"}
          </p>
        ...
        <div className="pt-2.5 border-t border-[var(--line-soft)] flex items-center justify-between mt-auto">
          <div className="flex items-center gap-3 font-mono text-[11px] text-[var(--text-mid)]">
            ...
            {typeof anime.favourites === "number" && (
              <span className="flex items-center gap-1 text-[#f472b6]">
                ...
                <span className="text-[var(--text-mid)]">{anime.favourites}</span>
              </span>
            )}
          </div>
